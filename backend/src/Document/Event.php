...
class Event
{
    ...
    /**
     * @var string $ethContractLocation contract location generated by Etherium API
     * @MongoDB\Field(type="string")
     * @Groups({"api_default"})
     */
    private $ethContractLocation;
     ...
     * @return string
     */
    public function getEthContractLocation(): ?string
    {
        return $this->ethContractLocation;
    }

    /**
     * @param string $ethContractLocation
     */
    public function setEthContractLocation(string $ethContractLocation): void
    {
        $this->ethContractLocation = $ethContractLocation;
    }
}
